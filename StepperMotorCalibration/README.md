...
The frequency of the laser is controlled by the PZT, but the PZT is not a linear instrument, so the output frequency can be written as the function of the voltage applied to it.
