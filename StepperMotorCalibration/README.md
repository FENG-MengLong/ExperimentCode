...
For F-P cavity, the resonant peaks are noted as $f_{0m}$, $m$ represents the order of the peak. So when scanning the PZT voltage using a triangular wave, we can see a series peaks with a symmetric axis at the center.![[Pasted image 20251129183531.png]]The position of the peak satisfies the $$\begin{align*}
f_{0m} &= F(V_{0m})
\end{align*}$$
