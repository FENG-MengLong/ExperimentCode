...
class AndorSDK2Camera(camera.IBinROICamera, camera.IExposureCamera):
    ...
    def __init__(self, idx=0, ini_path="", temperature=None, fan_mode="off", amp_mode=None):
        ...
        self._add_settings_variable("shutter",self.get_shutter_parameters,self.set_shutter,ignore_error=AndorSDK2LibError)
    ...
    _p_shutter_mode=interface.EnumParameterClass("shutter_mode",[("auto",0),("open",2),(True,1),("closed",1),(False,2)],allowed_alias="exact")
